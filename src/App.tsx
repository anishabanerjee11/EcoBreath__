...
const DEFAULT_INCIDENTS = [
  {
    ...
    description: "Spotted smoke and burning garbage plastic odor near the main Sector 1 market lane.",
  },
  {
    id: "inc2",
    ...
    timestamp: "1 day ago",
    status: "In Progress" as const,
    description: "High levels of dust due to active bridge construction without proper water spraying.",
  },
  {
    id: "inc3",
    title: "Vehicle Smog",
    ...
    description: "Heavy exhaust emissions from old transport buses blocking traffic visibility.",
  },
];
...
const DEFAULT_USER_PROFILE = {
  ...
  settings: {
    darkMode: true,
    language: "English",
    liveLocation: "granted" as const,
    notifications: true,
  },
};

const DEFAULT_AI_BRIEFING = {
...
const DEFAULT_SYNC_DATA: InitSyncData = {
...
export default function App() {
  ...
  const [syncData, setSyncData] = useState<InitSyncData>(DEFAULT_SYNC_DATA);
  const [aiBriefing, setAiBriefing] = useState<AIBriefing>(DEFAULT_AI_BRIEFING);
